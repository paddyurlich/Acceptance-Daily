...
function returnStats4G_sector($sector,$pp, $selection, $startDate, $endDate){
    ...
    $sql_string_first .=    "((sum(`DL Traffic Volume`) + sum(`UL Traffic Volume`)) /8/1024/1024/1024)
     ...
     $sql_string_first .=    "((SUM(`L.ChMeas.PRB.DL.Used.Avg`) / SUM(`L.ChMeas.PRB.DL.Avail`)) *100 )
      ...
      $sql_string_end = " FROM ranPU.Acceptance_Stats_4G_daily, ranPU.revenue_figures WHERE (Acceptance_Stats_4G_daily.Date BETWEEN '".$startDate."' AND '".$endDate."') AND right(Acceptance_Stats_4G_daily.Object,1)='".$sector."' AND (".$selectedCells.")";
