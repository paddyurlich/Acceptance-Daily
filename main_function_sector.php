...
function returnStats3G_sector($sector, $pp, $selection, $startDate, $endDate){
  ...
  if (isset($sector, $pp, $selection, $startDate, $endDate)) {
      ...
      $sql_string_end = " FROM ".$dbname.".Acceptance_Stats_3G_daily, ".$dbname.".revenue_figures WHERE (Acceptance_Stats_3G_daily.Date BETWEEN '".$startDate."' AND '".$endDate."') AND right(Acceptance_Stats_3G_daily.CELLNAME,1)='".$sector."' AND (".$selectedCells.")"; 
