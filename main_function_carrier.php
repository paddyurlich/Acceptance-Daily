...
function returnStats3G_carrier($carrier, $selection, $startDate, $endDate){
  ...
  if (isset($carrier, $selection, $startDate, $endDate)) {
      ...
      $sql_string_end = " FROM ".$dbname.".Acceptance_Stats_3G_daily, ".$dbname.".revenue_figures WHERE (Acceptance_Stats_3G_daily.Date BETWEEN '".$startDate."' AND '".$endDate."') AND mid(Acceptance_Stats_3G_daily.CELLNAME,10,5)='".$carrier."' AND (".$selectedCells.")"; 
