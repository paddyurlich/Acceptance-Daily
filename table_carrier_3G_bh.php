...
<?php 
    foreach ($fieldtype3G as $key => $value) {
        ...
        $stats_u09f1 = (float)($stats_post_carrier_bh_u09f1[0][$key]);
        $stats_u09f2 = (float)($stats_post_carrier_bh_u09f2[0][$key]);
        $stats_u21f1 = (float)($stats_post_carrier_bh_u21f1[0][$key]);
        $stats_u21f2 = (float)($stats_post_carrier_bh_u21f2[0][$key]);
        $stats_u21f3 = (float)($stats_post_carrier_bh_u21f3[0][$key]);
