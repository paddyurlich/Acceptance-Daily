...
*/
      ...
      $sql_string_end = " FROM ranPU.Acceptance_Stats_4G_daily, ranPU.revenue_figures WHERE (Acceptance_Stats_4G_daily.Date BETWEEN '".$startDate."' AND '".$endDate."') AND (".$selectedCells.") GROUP BY Cellname" ; 
