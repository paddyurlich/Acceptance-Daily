...
function returnStats3G_daily_bh($pp, $selection, $startDate, $endDate){
  ...
  // if (isset($pp, $selection, $startDate, $endDate)) {
    ...
    //     $KPI_name_array[] = $KPI_field_array[$x]['Field'];
     ...
     // }
      ...
      $sql_string_end = " FROM ranPU.Acceptance_Stats_3G_daily_bh, ranPU.revenue_figures WHERE (Acceptance_Stats_3G_daily_bh.Date BETWEEN '".$startDate."' AND '".$endDate."') AND (".$selectedCells.")"; 

      $SQL_string =  $sql_string_select.$sql_string_first.$sql_string_main.$sql_string_end;

    //   echo "<br><br><br><br>";
    //         echo "3G daily busy hour SQL = ".$SQL_string;
 ...
 //var_dump(returnStats3G_daily_bh($pp, $selection, $startDate, $endDate));
?>
